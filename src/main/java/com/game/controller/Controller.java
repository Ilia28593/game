...
//    public List<Player> getListPlayers(@RequestParam(defaultValue = "ID", value = "order") PlayerOrder order,
...
//        return service.getSortedPlayers(service.getAllPlayers(),order, pageNumber, pageSize);
    @GetMapping("/players")
